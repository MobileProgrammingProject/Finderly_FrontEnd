...
class UserViewModel : ViewModel() {
    ...
    fun lostRegister(userId: String, lostName: String, lostLocation:String, lostDate:String, storage:String, description: String, pictures: List<String>) {
        viewModelScope.launch {
            try {
                val response = RetrofitInstance.api.postLostItem(LostItemRequest(userId,lostName,lostLocation, lostDate, storage, description, pictures))
